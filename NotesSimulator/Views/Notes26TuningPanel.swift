...
/// iOS 26 备忘录文字样式
struct Notes26TuningPanel: View {
    @Binding var settings: Notes26TuningSettings
        ...
        NavigationStack {
            Form {
                Section {
                    ...
                    sliderRow("正文暖感（黄纸）", value: $settings.bodyYellowWarmth, range: 0...1, step: 0.01, format: "%.0f%%") {
                        $0 * 100
                    }
                }
            }
