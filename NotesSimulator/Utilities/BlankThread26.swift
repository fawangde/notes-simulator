...
/// iOS 26 信息页：两套独立空白会话（互不影响随机池）
enum BlankThread26 {
    /// 标准空白：第 2 行固定 + 随机 50（合计 51）
    enum Standard {
        static let consoleTag = "BlankThread26"
    ...
    enum GreenSMS {
        static let consoleTag = "BlankThread26Green"
        static let fixedLineIndex = 0
        static let randomBlankCount = 60
        static let seedSalt: UInt64 = 0x9E37_79B9_5A5E_71C3
    }
...
enum IOS26ComposeChromeStyle: Equatable {
    case standard
    case greenSMS
}
